        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                    ...
                    data-setbg="users/img/banner/banner-2.jpg">
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" d  data-setbg="users/img/banner/123333.jpg">
                            <div class="categories__text">
                                <h4>Men’s fashion</h4>
                                <p>358 items</p>
                                <a href="#">Shop now</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                    <div class="categories__item set-bg" d  data-setbg="users/img/banner/12222222.jpg">
                            <div class="categories__text">
                                <h4>Kid’s fashion</h4>
                                <p>273 items</p>
                                <a href="#">Shop now</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                    <div class="categories__item set-bg" d  data-setbg="users/img/banner/son-moi-ysl3.jpg">
                            <div class="categories__text">
                                <h4>Cosmetics</h4>
                                <p>159 items</p>
                                <a href="#">Shop now</a>
